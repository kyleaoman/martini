...
def find_fwhm(f: Callable[[ndarray], ndarray]) -> float: ...
...
class _BaseSPHKernel(metaclass=abc.ABCMeta):
    ...
    def _px_weight(
        self, dij: U.Quantity[U.pix], mask: ndarray | None = ...
    ) -> U.Quantity[U.pix**2]: ...
    ...
    def _init_sm_lengths(
        self, source: SPHSource | None = ..., datacube: DataCube | None = ...
    ) -> None: ...
    @abstractmethod
