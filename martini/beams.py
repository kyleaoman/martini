...
class WSRTBeam(_BaseBeam):
    ...
    def _load_beamfile(self):
        ...
        Returns
        -------
        2-tuple containing an astropy.io.fits.Header and an astropy.units.Quantity array.
        """
    ...
    def _centroid(self):
        ...
        Decgrid *= U.deg
        freqgrid *= U.Hz
        return tuple([A[tuple(np.array(bdata.shape) // 2)] for A in (RAgrid, Decgrid, freqgrid)])
